...
##### LAPTOP: <br />
 The RoboCup-2018-Driving-Code (RCDC) is used by the laptop. You will need to access the file within RCDC that describes the robot you require to drive. On our laptops, this file is located on the desktop.
...
## DRIVING CODE: <br />
 ##### INSTRUCTIONS: <br />
   ...
   8. Within this file you will find a pythin script named client.py. Open this file and run the code. NOTE: You are required to have a controller connected to the laptop otherwise an error will be raised. There will be an update with an image of the controls on the controller.
